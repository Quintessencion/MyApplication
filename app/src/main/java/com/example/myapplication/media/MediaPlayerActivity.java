...
public class MediaPlayerActivity extends AppCompatActivity implements OnPreparedListener, OnCompletionListener {
    ...
    final String DATA_SD = Environment
            .getExternalStoragePublicDirectory(Environment.DIRECTORY_MUSIC) + "/8 - Любовь и время.mp3";
    final Uri DATA_URI = ContentUris
            .withAppendedId(android.provider.MediaStore.Audio.Media.EXTERNAL_CONTENT_URI, 13359);
        ...
        try {
            switch (view.getId()) {
                ...
                case R.id.btnStartRaw:
                    ...
                    mediaPlayer = MediaPlayer.create(this, R.raw.dvbbs);
                    mediaPlayer.start();
                    break;
