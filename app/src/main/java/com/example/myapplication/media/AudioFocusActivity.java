...
public class AudioFocusActivity extends AppCompatActivity implements MediaPlayer.OnCompletionListener {
    ...
    public void onClickMusic(View view) {
        ...
        try {
            mpMusic.setDataSource("sdcard/Music/Music.mp3");
            mpMusic.prepare();
        } catch (IOException e) {
            e.printStackTrace();
        }
        mpMusic = MediaPlayer.create(this, R.raw.dvbbs);
