...
public class ContentProviderActivity extends AppCompatActivity {
    ...
    final Uri CONTACT_URI = Uri.parse("content://com.example.myapplication.contentProvider.AdressBook/contacts");
    ...
    public void onClickError(View v) {
        Uri uri = Uri.parse("content://com.example.myapplication.contentProvider.AdressBook/phones");
        try {
